...
class RequestActivity : AppCompatActivity() {
    ...
    // NOTE: The counter is NOT incremented here anymore!
    // It will be incremented only when driver completes the trip successfully
...
//                        // ✅ REMOVED: Counter increment here! Will be done by driver on completion
//                        // The emergency count will ONLY increase when driver completes the trip
//
...
//                        }
//
//                        Toast.makeText(this@RequestActivity, "🚨 Emergency request submitted! Tracking will start when a driver accepts.", Toast.LENGTH_LONG).show()
//                        startActivity(intent)
//                        finish()
//                    } else {
        ...
        if (validateInputs(patientName, patientAgeText, contactNumber, location)) {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    if (newRequest != null && newRequest.id != null) {
                        // ✅ NO COUNTER INCREMENT HERE - REMOVED!
                        // DO NOT increment counter on submission
                        ...
                        Toast.makeText(this@RequestActivity, "🚨 Emergency request submitted! Waiting for driver...", Toast.LENGTH_LONG).show()
                        startActivity(intent)
                        finish()
                    } else {
                        Toast.makeText(this@RequestActivity, "🚨 Emergency request submitted!", Toast.LENGTH_SHORT).show()
